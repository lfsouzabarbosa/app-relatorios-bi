        ...
        <section>
                            ...
                            <a class="sc-dIsAE default-dashboard__Card-y6jxa9-0 kgyQN kKlyvT admin-bro_Box">
                                ...
                                <div>
                                    <Box display="inline-flex" flexDirection="row" verticalAlign="center">
                                        ...
                                        <Box width="140px">
                                            <Text textAlign="right" marginTop="27px" fontSize="xl" fontWeight="900">63.747</Text>
                                        </Box>
                                    </Box>
                                ...
                                <div>
                                    <Box display="inline-flex">
                                        ...
                                        <Box width="140px">
                                            <Text textAlign="right" marginTop="27px" fontSize="xl" fontWeight="900">623
                                            </Text>
                                        </Box>
                                    </Box>
                                    <hr color="black" size="2" width="100%" ></hr>
                            ...
                            <a class="sc-dIsAE default-dashboard__Card-y6jxa9-0 kgyQN kKlyvT admin-bro_Box">
                                ...
                                <div>
                                    <Box display="inline-flex">
                                        ...
                                        <Box width="140px">
                                            <Text textAlign="right" marginTop="27px" fontSize="xl" fontWeight="900">20.189</Text>
                                        </Box>
                                    </Box>
                                    <hr color="black" size="2" width="100%" ></hr>
                                </div>
                                ...
                                <div>
                                    <Box display="inline-flex">
                                        ...
                                        <Box width="140px">
                                            <Text textAlign="right" marginTop="27px" fontSize="xl" fontWeight="900">948
                                            </Text>
                                        </Box>
                                    </Box>
                                    <hr color="black" size="2" width="100%" ></hr>
                            ...
                            <a class="sc-dIsAE default-dashboard__Card-y6jxa9-0 kgyQN kKlyvT admin-bro_Box">
                                ...
                                <div>
                                    <Box display="inline-flex">
                                        ...
                                        <Box width="140px">
                                            <Text textAlign="right" marginTop="27px" fontSize="xl" fontWeight="900">540</Text>
                                        </Box>
                                    </Box>
                                    <hr color="black" size="2" width="100%" ></hr>
                                </div>
                                ...
                                <div>
                                    <Box display="inline-flex">
                                        ...
                                        <Box width="140px">
                                            <Text textAlign="right" marginTop="27px" fontSize="xl" fontWeight="900">0
                                            </Text>
                                        </Box>
                                    </Box>
                                    <hr color="black" size="2" width="100%" ></hr>
            ...
            <Box margin="7px auto" padding="22px" display="flex" flexDirection="column"
                backgroundColor="#ffffff" boxShadow="card">
                    ...
                    <Box>
                        <Link href="https://www.jornaldocomercio.com/_conteudo/agro/2021/08/808698-jc-faz-homenagem-a-fapergs-na-25-edicao-do-premio-o-futuro-da-terra.html" >
                            <Text textAlign="start" fontSize="xl" fontWeight="400" color="black">JC faz homenagem à Fapergs na 25ª edição do Prêmio O Fundo da Terra</Text>
                            <Text textAlign="start" fontSize="x1" fontWeight="200" color="grey">Jornal do Comércio • 3 dias atrás</Text>
                        </Link>
                    </Box>
                </Box>
                ...
                backgroundColor="#ffffff" boxShadow="card">
                    ...
                    <Box>
                        <Link href="https://radioalianca.com.br/politica/autor-de-tentativa-de-homicidio-em-arvoredo-sera-julgado-na-proxima-segunda-feira" >
                            <Text textAlign="start" fontSize="xl" fontWeight="400" color="black">Autor de tentativa de homicídio em Arvoredo será julgado na próxima segunda-feira</Text>
                            <Text textAlign="start" fontSize="x1" fontWeight="200" color="grey">Rádio Aliança 750khz • Ontem</Text>
                        </Link>
                    </Box>
                </Box>
            ...
            <div>
                ...
                <Box boxShadow="card" border="2px solid #ffffff" backgroundColor="#ffffff" borderRadius="10px" maxWidth="800px" minHeight="300px" margin=" 10px auto 30px" >
                    <a href="http://vps23593.publiccloud.com.br:3002/" class="sc-dIsAE default-dashboard__Card-y6jxa9-0 kgyQN kKlyvT admin-bro_Box">
                        <Box display="flex" flexDirection="row" justifyContent="center" width="740px" >
                            <img width="700" height="250px" src="https://i.pinimg.com/564x/72/cb/3d/72cb3dfd961250c6b9fead03d1257e74.jpg" alt="Imagem Trends"></img>
                        </Box>
                    </a>
                </Box>
            </div>
