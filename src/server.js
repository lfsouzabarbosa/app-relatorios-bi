...
const run = async () =>{
  await mongoose.connect('mongodb+srv://techandsol:techandsol@cluster0.x9bvg.mongodb.net/configuracoes?retryWrites=true&w=majority', {
  ...
  telha.use(admin.options.rootPath, router);
