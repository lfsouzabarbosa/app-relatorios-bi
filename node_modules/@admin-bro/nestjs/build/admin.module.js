...
let AdminModule = AdminModule_1 = class AdminModule {
    ...
    onModuleInit() {
        ...
        const admin = new admin_bro_1.default(this.adminModuleOptions.adminBroOptions);
        const { httpAdapter } = this.httpAdapterHost;
        this.loader.register(admin, httpAdapter, Object.assign(Object.assign({}, this.adminModuleOptions), { adminBroOptions: admin.options }));
    }
};
